            ...
            <div className="right-content-3-5">
              ...
              <form style={{marginTop: "1.5rem"}} action="" method="post">
                <div style={{marginBottom: "1.75rem"}}>
                  <label for="" className="d-block input-label-content-3-5">Email Address</label>
                  <div className="d-flex w-100 div-input-content-3-5">
                    ...
                    <input className="input-field-content-3-5" type="email" name="" id="" placeholder="Your Email Address"
                      autocomplete="on" required />
                  </div>
                </div>
                <div style={{marginTop: '1rem'}}>
                  <label for="" className="d-block input-label-content-3-5">Password</label>
                  <div className="d-flex w-100 div-input-content-3-5">
                    <svg className="icon-content-3-5" style={{marginRight: '1rem'}} width="24" height="24" viewBox="0 0 24 24"
                      fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <input className="input-field-content-3-5" type="password" name="" id="" placeholder="Your Password"
                ...
                <button className="btn btn-fill-content-3-5 d-block w-100" type="submit">Log In To My Account</button>
              </form>
